...
export const ArtisanRegistrationStatus = () => {
  ...
  const { data: artisanData, isLoading: isLoadingApplication, refetch } = api.artisan.getApplicationStatus.useQuery(
    undefined, 
    {
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="w-full md:w-1/4 flex flex-col items-center">
                ...
                <div className="mt-1 text-sm text-center text-primary font-medium">
                  {artisanData.craft.craftName} {artisanData.subCraft && `• ${artisanData.subCraft.subCraftName}`}
                </div>
              ...
              <div className="w-full md:w-3/4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-700">Training</h3>
                  ...
                  {artisanData.certificate && (
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{artisanData.certificate}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {artisanData.recongnition && (
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-gray-700">Recognitions</h3>
                        <p className="text-gray-600">{artisanData.recongnition}</p>
                      </div>
                    </div>
                  )}
                </div>
    ...
    return (
      <Card className="border-gray-200 shadow-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Join our network of skilled Kashmiri artisans or check your application status
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            <div className="flex flex-col space-y-4 p-6 rounded-xl bg-primary/5 border border-primary/10">
              ...
              <p className="text-center text-sm text-gray-600">
                If you&apos;re a skilled artisan looking to join our platform, start your application
              </p>
              <Button 
