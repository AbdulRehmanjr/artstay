...
export const DiningCreationForm = () => {
  ...
  return (
    <>
      <div className="mb-8">
        <h3 className="mb-2 text-3xl font-bold font-heading">Dining Voyage</h3>
        <h4 className="mb-4 text-xl font-semibold font-heading">Restaurant Registration</h4>
        <p className="text-gray-600">
          Share your restaurant with visitors seeking authentic culinary experiences in Kashmir.
          Complete the form below to add your restaurant to our Dining Voyage platform.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    ...
                    <FormDescription>
                      Describe your restaurant, cuisine, ambiance, and what makes it special
                    </FormDescription>
                    <FormControl>
                      <Textarea
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Upload a high-quality image of your restaurant (exterior, interior, or signature dish)</FormDescription>
                  <FormControl>
                    <UploadDropzone
                  ...
                  {field.value && (
                    <div className="mt-2">
                      ...
                      <Image src={field.value} alt="Restaurant Image" width={100} height={100} />
                    </div>
                  )}
                  <FormMessage />
                </FormItem>
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="mt-4 text-center text-sm text-gray-500">
              <p>Once created, you&apos;ll be able to add menu items to your restaurant.</p>
              <p className="mt-2">
                For assistance, contact us at <span className="text-blue-600">support@diningvoyage.com</span>
              </p>
            </div>
          </div>
        </form>
